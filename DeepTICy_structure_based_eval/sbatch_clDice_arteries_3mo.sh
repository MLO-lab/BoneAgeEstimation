#!/bin/bash
#SBATCH --job-name=cldice_arteries
...
IMS_PATH="data_prediction_metric/190429KK st6 CBMM E1 arteries miSca1_mpArteries_mArteries(Laminin) for Yihao.ims"
LEVEL=0

CH_GT=2 # only for 3mo data, we use 2 as the GT
CH_PRED=1
T_GT=1
T_PRED=1
...
TAG="arteries_3mo" # the comparison tag 
